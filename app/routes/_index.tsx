...
export const meta: MetaFunction = () => {
    return [
        { title: "Binge Watch" },
        { name: "description", content: "Welcome to BingeWATCH!" },
    ];
};
...
interface ILoaderData {
    trendingThisWeek: IContent[];
    lastWatched: IContent[];
}

export const loader: LoaderFunction = async () => {
    // TODO: Replace for call to the API.
    ...
    const lastWatched: IContent[] = example.slice(0, 3)

    const data: ILoaderData = {
        trendingThisWeek: example,
...
export default function Index() {
    ...
    return (
        <>
            <img
                src={`https://image.tmdb.org/t/p/original${data.trendingThisWeek[selectedContent].backdrop_path}`}
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1">
                ...
                >
                    <CarouselContent>
                        {data.trendingThisWeek.map((value) => (
                ...
                <div className="w-full h-fit">
                    ...
                    <div className="flex flex-col-reverse w-full h-full mb-3">
                        {data.lastWatched.map((value, index) => (
                            <Card
                                key={value.id + index}
